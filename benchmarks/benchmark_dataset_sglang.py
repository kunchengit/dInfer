...
def main(world_size, rank, gpu_id, args):
    ...
    # print(model_config.use_qk_norm)
    ...
    out = dllm.generate(sorted_input_ids[0], gen_length=sorted_input_ids[-1].shape[1]+sorted_padded_gen_lens[-1], block_length=block_length)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model_name', type=str, default='/data/dulun/models/dllm-mini-nobd/dllm-mini/block-diffusion-sft-2k-v2-full-bd/checkpoint-8904')
    # parser.add_argument('--model_name', type=str, default='/data/dulun/models/llada2-flash')
    
    # parser.add_argument('--dataset', type=str, default='/data/dulun/datasets/dumped_prompt/dllm_mini_251017/openai_humaneval.json')
